...
\title{ Risk of Streaming Estimators \\ Controlled by Alpha Investing }
\author{
...
\abstract{ 
 ...
 Streaming feature selection is a very greedy approach to variable selection that evaluates
