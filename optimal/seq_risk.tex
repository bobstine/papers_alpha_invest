...
\item {\bf Stationarity} of the associated wealth process, perhaps using results from
\citet{chanTong94} for the ergodicity of the process in the universal case.
